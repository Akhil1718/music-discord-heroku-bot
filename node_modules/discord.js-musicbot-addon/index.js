...
try {
      ...
      constructor(client, options) {
        ...
        this.play = {
          ...
          masked: "play"
               ...
               // Play Command options
        this.p = {
          enabled: (options.p == undefined ? true : (options.p && typeof options.p.enabled !== 'undefined' ? options.p && options.p.enabled : true)),
          run: "playFunction",
          alt: (options && options.play && options.play.alt) || [],
          name: (options && options.play && options.play.name) || "p",
          usage: (options && options.play && options.play.usage) || null,
          exclude: Boolean((options && options.p && options.p.exclude)),
          masked: "p"
        };
    ...
    musicbot.loadCommands = async () => {
      try {
        ...
        await musicbot.loadCommand(musicbot.p);
